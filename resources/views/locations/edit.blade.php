    ...
    <div class="container-fluid">
        <div class="location-form-container">
            ...
            <div class="location-info-box">
                ...
                <p class="mb-1"><strong>Ubicación Completa:</strong> {{ $location['sucursal'] }} - {{ $location['seccion_sucursal'] }} - Estante {{ $location['estante'] }} - Sección {{ $location['seccion_estante'] }}</p>
                <p class="mb-0"><strong>Código:</strong> {{ $location['codigo_ubicacion'] }}</p>
            </div>

            <form method="POST" action="{{ route('locations.update', $location['id']) }}" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="sucursal" name="sucursal" 
                                   value="{{ old('sucursal', $location['sucursal']) }}" required maxlength="100"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="seccion_sucursal" name="seccion_sucursal" 
                                   value="{{ old('seccion_sucursal', $location['seccion_sucursal']) }}" required maxlength="100"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="estante" name="estante" 
                                   value="{{ old('estante', $location['estante']) }}" required maxlength="50"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="seccion_estante" name="seccion_estante" 
                                   value="{{ old('seccion_estante', $location['seccion_estante']) }}" required maxlength="50"
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="codigo_ubicacion" name="codigo_ubicacion" 
                                   value="{{ old('codigo_ubicacion', $location['codigo_ubicacion']) }}" required maxlength="100"
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion" 
                                      rows="3" placeholder="Descripción adicional de la ubicación...">{{ old('descripcion', $location['descripcion']) }}</textarea>
